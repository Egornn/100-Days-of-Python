...
my_label = tk.Label(text="Some text on the label", font=("Courier", 25, "bold"))
...
my_button = tk.Button(text='Random Button', command=button_clicked)
my_button.grid(column=1, row=1)
# my_button.pack(side='top')

my_second_button = tk.Button(text='Second Button')
